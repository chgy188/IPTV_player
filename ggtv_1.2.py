...
class IPTVPlayer(QMainWindow):
    ...
    def create_menu(self):
        ...
        # 创建恢复按钮
        self.restore_button = QPushButton("切回")
    ...
    def on_search_clicked(self):
        ...
        if search_text:
            self.result_dict=self.search_channels(search_text)
    ...
    def play_program(self, program_url, pos=0):
        ...
        if self.player:
            ...
            # self.player = MediaPlayer(program_url, thread_lib='python',loglevel='error', callback=self.player_callback)
